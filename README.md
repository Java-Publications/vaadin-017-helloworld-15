...
# Backend meets Frontend: Develop UI elements with ease
The roles and rights of our web application stand. Now we can start building and integrating the first UI components. Of course that also means that we test these components.
...
* german article [http://bit.ly/jaxenter-015](http://bit.ly/jaxenter-015)
